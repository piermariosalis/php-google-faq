<?php 
    ...
    $answers = [
        ...
        "answ_two" => "<p>Sappiamo che la sicurezza e la privacy sono importanti per te e lo sono anche per noi. Per noi è imperativo offrire un'elevata sicurezza e assicurarti che le tue informazioni sono al sicuro e accessibili quando ne hai bisogno.</p>
...
<body>
    ...
    <main>
        <section id="one">
            ...
            <h2><?php echo $questions["quest_one"] ?></h2>
            <div><?php echo $answers["answ_one"] ?></div>


        </section>
        <section id="one">
            <h2><?php echo $questions["quest_two"] ?></h2>
            <div><?php echo $answers["answ_two"] ?></div>
        </section>
        <section id="one">
            <h2><?php echo $questions["quest_three"] ?></h2>
            <div><?php echo $answers["answ_three"] ?></div>

        </section>
        <section id="one">
            <h2><?php echo $questions["quest_four"] ?></h2>
            <div><?php echo $answers["answ_four"] ?></div>
        </section>
    ...
    <footer>
        ...
        <div id="footer_content">
            ...
            <div id="footer_left">
                ...
                <span><a href="">Tutto su Google</a></span>
